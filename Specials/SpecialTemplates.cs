...
namespace SpaceMarine
{
    public class BurstFire : SpecialTemplate
    {
        ...
        public override string[] Weapons => ["Crossbow", "Hydra Rockets", "Icicle Impale", "Railgun"];
    ...
    public class Incendiary : SpecialTemplate
    {
        ...
        public override string[] Weapons => ["Missile", "Hydra Rockets", "Icy Barrage", "Eruption"];
    ...
    public class Icicles : SpecialTemplate
    {
        ...
        public override string[] Weapons => ["Ice", "Icicle Impale", "Icy Barrage", "Precision Laser"];
    ...
    public class PiercingShot : SpecialTemplate
    {
        ...
        public override string[] Weapons => ["Laser", "Railgun", "Precision Laser", "Elite Laser"];
    ...
    public class FlameSpreader : SpecialTemplate
    {
        ...
        public override string[] Weapons => ["Fire", "Elite Laser", "Eruption"];
