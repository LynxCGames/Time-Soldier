...
public class SapperSelect : ModifierSelect
{
...
public class SapperLevel : ModifierLevel
{
    public override string ModName => "Sapper";
...
public class SapperEquiped : ModifierEquiped
{
    public override string ModName => "Sapper";
    public override void EditTower(ModifierTemplate modifier, Tower tower)
    {
        ...
        if (SpaceMarine.mod.weapon == "Graviton")
        {
            ...
            {
                if (behavior.name.Contains("FortModifier"))
                {
